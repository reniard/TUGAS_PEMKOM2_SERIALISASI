 ...
 * @author ASUS
 */
public class AddProduct extends javax.swing.JDialog implements Serializable {
    private static final long serialVersionUID = 1L; //Tambahkan serialVersionUID
    private transient DefaultTableModel model; //Tambahkan transient
    private String DEFAULT_ID;
    private String DEFAULT_NAMA_PRODUK;
    /**
...
private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    if(id_produk.isEmpty() || nama_produk.isEmpty()){
        ...
        for (int i = 0; i < row; i++) {
            ...
            String item_price = tabelItem.getValueAt(i, 0).toString();
            double price = Double.parseDouble(item_price);
            ProductItem pi = new ProductItem(item_name, price);
            p.add(pi);
        }
        
        //Menggunakan data default jika input kosong
        if (id_produk.isEmpty()) id_produk = DEFAULT_ID;
        if (nama_produk.isEmpty()) nama_produk = DEFAULT_NAMA_PRODUK;
        ...
        this.dispose();
        JOptionPane.showMessageDialog(this, "Data Telas Di Simpan");
    }
}
...
private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    System.out.println("Baris baru ditambahkan ke dalam tabel.");
}
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ITEM PRODUK", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(118, 118, 118)
                                .addComponent(txtNamaItem, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(jLabel4)
                                .addGap(114, 114, 114)
                                .addComponent(txtHargaItem, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)))
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(107, 107, 107)
                        .addComponent(txtNamaProduk, javax.swing.GroupLayout.PREFERRED_SIZE, 318, javax.swing.GroupLayout.PREFERRED_SIZE)))
